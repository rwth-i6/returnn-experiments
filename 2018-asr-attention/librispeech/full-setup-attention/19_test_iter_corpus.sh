...
./returnn/tools/dump-dataset.py \
  "{'class':'LibriSpeechCorpus', 'bpe':{'bpe_file':'data/dataset/trans.bpe.codes', 'vocab_file':'data/dataset/trans.bpe.vocab'}, 'path':'data/dataset', 'audio':{}, 'prefix': 'train', 'use_zip': True}" \
  --endseq -1 --type null
