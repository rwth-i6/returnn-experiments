network = {
    ...
    "source_dropout": {"class": "dropout", "from": "source_linear", "dropout": 0.135},
    ...
    "conformer_block_01_ffmod_1_ff1": {
        ...
        "L2": 9e-05,
        "forward_weights_init": "variance_scaling_initializer(mode='fan_avg', distribution='uniform', scale=1.0)",
        "param_dropout": 0.09000000000000001,
    },
    ...
    "encoder": {"class": "copy", "from": "conformer_block_10"},
    "ctc": {
        "class": "softmax",
        "from": "encoder",
        "target": "bpe_labels",
