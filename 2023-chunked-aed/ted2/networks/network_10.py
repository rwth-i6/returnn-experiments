network = {
    ...
    "source_dropout": {"class": "dropout", "from": "source_linear", "dropout": 0.105},
    ...
    "conformer_block_01_ffmod_1_ff1": {
        ...
        "L2": 7e-05,
        "forward_weights_init": "variance_scaling_initializer(mode='fan_avg', distribution='uniform', scale=1.0)",
        "param_dropout": 0.06999999999999999,
    },
    ...
    "encoder": {"class": "copy", "from": "conformer_block_06"},
    "ctc": {
        "class": "softmax",
        "from": "encoder",
        "target": "bpe_labels",
    ...
    "global_mean": {
        "class": "constant",
        "value": eval(
            "exec('import numpy') or numpy.loadtxt('/u/zeineldeen/setups/ubuntu_22_setups/2023-04-17--conformer-att/work/i6_core/returnn/dataset/ExtractDatasetMeanStddevJob.UHCZghp269OR/output/mean', dtype='float32')"
        ),
        "dtype": "float32",
    },
    "global_stddev": {
        "class": "constant",
        "value": eval(
            "exec('import numpy') or numpy.loadtxt('/u/zeineldeen/setups/ubuntu_22_setups/2023-04-17--conformer-att/work/i6_core/returnn/dataset/ExtractDatasetMeanStddevJob.UHCZghp269OR/output/std_dev', dtype='float32')"
        ),
        "dtype": "float32",
    },
}
